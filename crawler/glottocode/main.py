...
for lingua in linguas:
    ...
    try:
        ...
        print(glottocode)
        response = requests.put(f'{HOST}/linguas/{lingua["id_lingua"]}', data=json.dumps({'nome': lingua['nome'], 'glottocode': str(glottocode)}), headers={'content-type': 'application/json'})
        print(response.text)
    except:
        ...